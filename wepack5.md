    ...
    rules: [
      {
        ...
        //use使用多个loader
        // use 数组里面 Loader 执行顺序是从右到左（由下到上）
        use: [
            "style-loader", //将 js 中的css 通过style标签添加到html中
    ...
    rules: [
      {
        ...
        test: /\.css$/,
        // use 数组里面 Loader 执行顺序是从右到左
       //use: ["style-loader", "css-loader", ] style-loader 被 MiniCssExtractPlugin.loader 替换
...
// 判断是否支持HMR功能
if (module.hot) {
//count.js  更新后值刷新这个文件 并执行后面的函数 也可以不写
...
cnpm i @vue/preload-webpack-plugin -D  可以安装上
确定这是webpack5的视频，preload-webpack-plugin默认版本安装不上,需要这个命令npm i preload-webpack-plugin@next -D
```
      ...
      presets: [
          [
              "@babel/preset-env",
              {
                  ...
                  corejs: { version: "3.8", proposals: true }//指定js版本
              },
          ],
      ],
  }
...
[原理分析](https://yk2012.github.io/sgg_webpack5/origin/)
